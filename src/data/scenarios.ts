...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    matchPatterns: [
      ...
      'risk score by metal',
      'system failure',
      'temporary issue with risk scores',
    ],
  ...
  },
  {
    ...
    summary: 'Access needed for Risk Adjustment Model',
    matchPatterns: [
    ...
    narrative: [
      {
        text: 'I found the right path for this — but you don’t currently have access to Risk Adjustment Model.',
        type: 'interpretation',
      },
      {
        text: 'You can request standing access, or rephrase to stay within data you can see.',
        type: 'interpretation',
      },
    ],
    refinementChips: [],
